...
from wisqi.backends.win32 import WindowsBackend
from wisqi.frontends.win32 import WindowsFrontend
from wisqi import errors
import logging
...
class Wisqi(object):
    ...
    def run_uninstaller(self):
        ...
        except errors.WisqiCorruptionError:
    ...
    def run_cd_menu(self):
        '''
        If Wisqi is run off a CD, run the CD menu (old umenu)
        '''
    ...
    def parse_commandline_arguments(self):
        ...
        parser.add_option("--force-wisqi", action="store_true", dest="force_wisqi", help="Show Wisqi option in CD menu even when using a DVD")
