...
class Backend(object):
    ...
    def create_preseed_diskimage(self):
        ...
        source = join_path(self.info.data_dir, "wisildr-disk.cfg")
        target = join_path(self.info.install_dir, "wisildr-disk.cfg")
    ...
    def modify_grub_configuration(self):
        ...
        dic = dict(
            ...
            rootflags = rootflags,
            title1 = "Completing Squibby installation.",
    ...
    def remove_target_dir(self, associated_task=None):
        ...
        try:
            ...
            if e.errno == 22:
                ...
                raise errors.WisqiCorruptionError
