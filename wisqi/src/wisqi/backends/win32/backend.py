...
from wisqi.backends.common.backend import Backend
from wisqi.backends.common.utils import run_command, spawn_command, replace_line_in_file, read_file, write_file, join_path, remove_line_in_file
from wisqi.backends.common.mappings import country2tz, name2country, gmt2country, country_gmt2tz, gmt2tz
...
class WindowsBackend(Backend):
    ...
    def remove_existing_binary(self):
        try:
            binary = os.path.join(self.get_startup_folder(), 'wisqi.exe')
        ...
        if os.path.exists(binary):
            try:
                ...
                log.exception("Couldn't remove Wisqi from startup:")
